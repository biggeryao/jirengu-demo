...
window.dom = {
  ...
  remove: function remove(node) {
    node.parentNode.removerChild(node);
    return node;
  },
  ...
  on: function on(node, eventName, fn) {
    node.addListListener(eventName, fn);
  },
  off: function off(node, eventName, fn) {
    node.removeListListener(eventName, fn);
  },
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1157" + '/');
